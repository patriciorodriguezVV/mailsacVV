/*
 Test Case Name: Cosmetologist - Initial - Military Spouse Temporary, document uploaded
 Purpose: Verify that the user is is no longer stopped from moving forward after uploading the documentation
 Steps:
	 1-Open Browser.
	 ...
	 7-Answer both questions with 'Yes'and upload Military family document.
	 8-Acknowledge.
	 ...
	 24-Close browser.
 Revision Notes:
 08/01/2022: Ivan Arno - https://visualvault.atlassian.net/browse/IMPL-2026
 */
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Demographics.clickOnUploadDocumentButton'()
