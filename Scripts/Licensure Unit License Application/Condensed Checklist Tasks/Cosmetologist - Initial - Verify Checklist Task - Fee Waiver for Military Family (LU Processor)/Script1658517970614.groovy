...
String taskName = 'Fee Waiver, Military Family Eligibilty Documentation for ' + user + ' and license ' + licenseType
...
// Verify task name (Fee Waiver, Military Family Eligibilty Documentation) and status
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Checklist.clickOnTask'('Task2', taskName)
