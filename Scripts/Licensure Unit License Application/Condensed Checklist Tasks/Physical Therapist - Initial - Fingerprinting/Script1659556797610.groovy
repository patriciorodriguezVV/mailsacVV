/*
 Test Case Name: Physical Therapist - Initial - Fingerprinting
 Purpose: Verify that the user is stopped from moving forward by a checklist item asking for the user to acknowledge the background check and fingerprinting procedure
 Steps:
	1-Open Browser.
	...
	16-Validate that the user is stopped by a checklist item asking to acknowledge the background check and fingerprinting procedure
	...
	24-Close browser.
 Revision Notes:
 08/04/2022: Ivan Arno - https://visualvault.atlassian.net/browse/IMPL-2033
 */
...
String taskDescriptionFingerprinting = 'Fingerprints for a Criminal Background check are required for license approval.\nYou must obtain a new criminal background check for your current application. You cannot use a criminal background check obtained for a previous application, or another type of license, or a license in another state.\n1. Criminal background checks are not expedited for any reason.\n2. The Nebraska State Patrol will not process your background check until we receive your license application.\nClick here for instructions: Background Check Instructions.\nTo continue, press the acknowledge button to indicate you have read and understand the requirements for the criminal background check.'
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Checklist_Management.verifyTaskDescription'(taskDescriptionFingerprinting)
