...
String titleMessage = 'Missing checklist tasks'
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Checklist.clickOnApplicationApprove'()

// Verify Messaging asking to approve the Checklist Tasks and Verify Status has not changed
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application.verifyStatus'(statusApplication)
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Manage.clickOnApplicationApprove'()
