/*
Script Name:	Registration Failed - User cease and desist - US Citizen - Random Nickname - Duplicated Last Name - contact DHH
				
Purpose:		The purpose of this script is to attempt to register a user using the a nick name for the first name and same last 
				name of the user registered within the precondition. When attempting to submit the registration the user should get
				an error message informing that the registration can’t be completed and needs to contact DHHS.
 				
Revision Notes:
			 	07/21/2022 - Federico Cuelho: Initial creation of the test case.
*/
...
String lastName = 'AutomationImplNineteenSixtySix'
String dob = '04/19/1981'
String zipCode = '33513'
String addressLine = 'PO BOX 4'
String ssn = '072112222'
String email = 'federico.cuelho+AIMPL1966@visualvault.com'
