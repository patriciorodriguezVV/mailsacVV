...
String firstName = 'PRlmrpt'
String lastName = 'AutomationNoCitizenbqwmk'
String aka = 'PRlmrpt, AutomationNoCitizenbqwmk'
String dob = '06/29/1977'
String alienNum = '952534244'
String placeOfBirth = 'Toronto'
String addressLine = 'PO BOX 4'
String phoneNumber = '2222222222'
String email = 'pruebas.onetree+ApplicantNoCitizenlmrpt@gmail.com'
...
// Enter Alien Identification Number
CustomKeywords.'pages.Page_Licensure_Unit_User_Registration.completeAlienRegistrationNum'(alienNum)
