...
// Set modal variables
String titleMessage = 'Existing Individual Record Match Found'
String bodyMessageEmailDuplicated = 'An existing Individual Record has been found matching the information you have entered. An account has been created for that User Registration record and login credentials have been sent by email.'


// Set Existing Registered User Variables
String firstName = 'PRopdda'
...
String randomMail = Generic_functions.randomString(chars, 5)
GlobalVariable.G_Applicant_Email = (('applicantCitizen' + randomMail) + GlobalVariable.MailsacDomain)
