...
// Set TCs dependency
String[] parentsTC = ['Test Cases/Licensure Unit License Application/Approve Physical Therapist Checklist Tasks']
// Verify any TC dependency has failed
CustomKeywords.'tc_listener.tcl.checkErrors'(parentsTC)


String modalDialogTitle = 'Application Approved'
String modalDialogBody = 'License Application has been marked as approved.'
int currentTab = 0
