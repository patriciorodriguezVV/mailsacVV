/*
 Test Case Name: Cosmetologist - Initial - Other
 Purpose: Verify that the user is prompted to acknowledge they will get the cosmetology school verification form filled out
 Steps:
	 1-Open Browser.
	 ...
	 18-Confirm Checklist item telling userthey will get the cosmetology school verification form filled out.
	 ...
	 24-Close browser.
 Revision Notes:
 07/28/2022: Ivan Arno - https://visualvault.atlassian.net/browse/IMPL-2024
 */
...
String taskDescriptionSchoolVerification = 'Please click to open and download the Cosmetology School Verification Form. Provide the form to your school and have them complete it and return it back to the licensure unit to be included with your application. If your school returned the form to you, you may use the "Upload Document' + "' button below to upload it, or click 'Next' to continue with your application. This document is optional for you to upload and you can submit your application without it."
...
CustomKeywords.'pages.Page_Licensure_Unit_License_Application_Checklist_Management.verifyTaskDescription'(taskDescriptionSchoolVerification)
